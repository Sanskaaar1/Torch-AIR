...
```
/torch-air:torch-accelerator-readiness spyre
/torch-air:torch-accelerator-readiness spyre --security
/torch-air:torch-accelerator-readiness spyre --all
...
- **Metadata table** — accelerator name, backend package, version, deployment model, torch-air version, model
...
| Points | Meaning |
|--------|---------|
| 2 | Fully implemented / evidenced |
| 1 | Partially implemented / evidenced |
| 0 | Not implemented / not evidenced |
...
where `score_i` is the row's score (0, 1, or 2), `w_i = 1 / priority_i`, and N/A rows are excluded.
...
│       ├── checklist.md              # Functional readiness checklist template
