...
2. **Summary at top**: Every generated document must start with the Executive Summary and Section Scores table (sorted by level) immediately after the header metadata. Metadata must include torch-air version and model.
